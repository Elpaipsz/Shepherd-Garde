  ...
  return (
    <div className="flex-1 bg-background flex flex-col items-center justify-center pt-32 pb-20 px-6">
      <div className="w-full max-w-[400px] flex flex-col items-center">
        ...
        <Suspense fallback={<div className="h-64 flex items-center justify-center"><span className="animate-spin h-6 w-6 border-2 border-primary border-t-transparent rounded-full" /></div>}>
          <LoginForm />
        </Suspense>
